...
return [
  ...
  "trece"             =>  [
# --------------------------------------------------------------------
    "version"   =>  "0.13.13",  # http://trece.io/changelog
...
//  "confirm"           =>  "confirm",
  ...
  "table"               =>  [
# --------------------------------------------------------------------
    "prefix"            =>  $prefix=ENTROPY_AS_PREFIX_FOR_DATABASE_NAMES,
    "log"               =>  $prefix."_log|l",
    "users"             =>  $prefix."_users|u",
    "gender"            =>  $prefix."_ugender|ug",
    "hierarchy"         =>  $prefix."_uhierarchy|uh",
    "privileges"        =>  $prefix."_uprivileges|pv",
  ],
...
# --------------------------------------------------------------------
    ...
    "username_blacklist" =>  "trece",
    "mainaction"         =>  "users", # ie: if "users", then http://domain.com/quenerapu == http://domain.com/users/quenerapu
  ],
...
# --------------------------------------------------------------------
    ...
    "image"             =>  [
                 "file" =>  "https://trece.io/img/trece.jpg",
          "description" =>  [
