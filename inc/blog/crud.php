...
class Blog{
  ...
  public $query1 = "";
  public $query2 = "";
  public $xx = ["id_status","date","title","url_title","intro","post","ids_labels","date_upd","ip_upd","ref","loops_ref"];
  public $xx_updateOne = ["id_status","date","title","url_title","intro","post","ids_labels"];
...
//  LABELS
    $this->query1.= "CONCAT((SELECT GROUP_CONCAT(".$this->labels_tableletter.".`name` ORDER BY FIND_IN_SET(". $this->labels_tableletter.".`id`,@ids_labels) SEPARATOR '<br>') FROM `".$this->labels_tablename."` ".$this->labels_tableletter." WHERE FIND_IN_SET(". $this->labels_tableletter.".`id`,@ids_labels))) as labels, ";
    ...
    (!is_null($searchLabel) && !empty($searchLabel) ? ($where?"AND ":"WHERE ")." FIND_IN_SET(".$searchLabel.",".$this->tableletter.".`ids_labels`) " : " ");
