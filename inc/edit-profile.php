...
$imageFolder  = $conf["dir"]["images"]; # Images upload/select path
$prefix       = "bio-img-";
$max_img      = 1200;
$max_icon     = 600;
$max_thumb    = 120;
...
//    || $app->getUserHierarchy() != 1 # Must be admin
  ...
  $cconf    = require($users."/".$conf["file"]["conf"].".php");
  $lCustom  = require($users."/".$conf["file"]["i18n"].".php");
...
//Wrong reference? Get out of here!
  ...
  $trece = new $users($db,$conf,$cconf,$lCommon,$lCustom);
...
# .................................................................................
  ...
  if(isset($_GET["filebrowser"])) : ?>
    ...
    <style>
      ...
      div.thumbs li div.check:hover img { box-shadow:0 0 5px #333; transform:scale(1.1); }
    ...
    <div class="row">
      <div class="thumbs">
        <ul>
<?php foreach(glob($imageFolder."*.{jpg,JPG,jpeg,JPEG,png,PNG}",GLOB_BRACE) as $file): ?>
          ...
          <li>
            <div class="check">
              ...
              <div class="rightblock">
                ...
                <a class="file" data-src="<?=$base."_thumb.".$ext;?>" href=""><span><?=$max_thumb;?> px.</span></a>
              </div>
              <div class="leftblock">
...
//$accepted_origins = array("http://localhost", "http://xxx.xxx.xxx.xxx", "https://whatever.com");
  ...
  if(is_uploaded_file($temp["tmp_name"])) :
    ...
    $filename = $imageFolder.$prefix.$trece->ref."-".uniqid();
    ...
    if($width>$height) : $max_height=$max_img;$max_width=floor($width*($max_height/$height)); endif;
    if($height>$width) : $max_width=$max_img;$max_height=floor($height*($max_width/$width)); endif;
    resizeImage($source,$filename."_img".".".$extension,$width,$height,$max_width,$max_height);
    if($width>$height) : $max_height=$max_icon;$max_width=floor($width*($max_height/$height)); endif;
    if($height>$width) : $max_width=$max_icon;$max_height=floor($height*($max_width/$width)); endif;
    resizeImage($source,$filename."_icon".".".$extension,$width,$height,$max_width,$max_height);
    resizeImage($source,$filename."_thumb".".".$extension,$width,$height,$max_thumb,$max_thumb);
...
<?php endif; ?>
  ...
  <script>
    tinymce.init({
      ...
      plugins: [ "fullscreen visualblocks template autolink charmap image link media paste wordcount lists code" ],
      toolbar: "fullscreen visualblocks | template | bold italic strikethrough bullist numlist link | image | charmap",
      visualblocks_default_state: true,
      templates: [{title:"Some title 1", description:"Some desc 1", content:"My content"},
                  {title:"Some title 2", description:"Some desc 2", url:"tinymce_template2.html"},
                 ],
      template_replace_values: { name:"Jack Black", staffid:"991234" },
