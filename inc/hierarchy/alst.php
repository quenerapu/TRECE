        ...
        <table class="table table-condensed sortable" style="margin:.5em 0;">
          <thead>
            <tr>
              ...
              <th><?=$lCustom["color"][$conf["site"]["lang"]];?></th>
              <th><?=$lCommon["name"][$conf["site"]["lang"]];?></th>
              <th><?=$lCustom["privileges"][$conf["site"]["lang"]];?></th>
          ...
          <tbody class="sortable-item" id="sort-<?=$trece->id[$i];?>">
            <tr class="handle">
              ...
              <td nowrap style="text-align:right;">
                ...
                <a data-ref="<?=$trece->ref[$i];?>" data-name="<?=$trece->name[$i];?>" data-ids_privileges="<?=$trece->ids_privileges[$i];?>" data-toggle="tooltip" data-placement="bottom" title="<?=$lCommon["clone"][$conf["site"]["lang"]];?>" class="clone-object" style="cursor:pointer;"><i class="fa fa-files-o fa-fw" aria-hidden="true"></i></a>
