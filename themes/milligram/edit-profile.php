...
//Wrong reference? Get out of here!
  ...
  $cconf = require_once($conf["dir"]["includes"].$conf["dir"]["users"]."/".$conf["file"]["conf"].".php");
  $lCustom = require_once($conf["dir"]["includes"].$conf["dir"]["users"]."/".$conf["file"]["i18n"].".php");
...
?>
  ...
  <div class="container main-container">
    ...
    <div class="row">
      ...
      <form id="form" class="form-classic" method="post" enctype="multipart/form-data">
