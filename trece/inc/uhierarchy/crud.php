...
class UHierarchy{
  ...
  public $query1 = "";
  public $query2 = "";
  public $xx = ["id_status","name","color","ids_privileges","sort","date_upd","ip_upd","ref","loops_ref"];
  public $xx_updateOne = ["id_status","name","color","ids_privileges"];
  ...
  public function __construct($db,$conf=null,$cconf=null,$lCommon=null,$lCustom=null) {
    ...
    $this->tablename    = explode("|",$this->conf["table"]["uhierarchy"]);
...
# ......................................................
  ...
  function readAll($records_per_page=6,$page=0,$from_record_num=0,$where=null) {
    ...
    $this->query = "SELECT ".$this->query1."FROM `".$this->tablename."` ".$this->tableletter.$qwhere.
                   "ORDER BY ".$this->tableletter.".`id_status` ASC, CASE WHEN ".$this->tableletter.".`name` COLLATE utf8mb4_general_ci LIKE '".$this->cconf["default"]["name"]."%' THEN 1 ELSE 2 END, ".$this->tableletter.".`sort` ASC " .
...
# ..............................................................
    ...
    function sort() { # Reorder
      ...
      foreach ($this->sort as $value) :
        ...
        $this->tableletter.".`sort` = :sort " .
        "WHERE ".$this->tableletter.".`id` = :id";
