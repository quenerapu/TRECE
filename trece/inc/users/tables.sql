...
CREATE TABLE `inconceivable_users` (
  ...
  `ugender` char(1) COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `hash_pass` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `password_change_hash` char(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `password_change_timestamp` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `password_change_ip` varchar(39) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0.0.0.0',
