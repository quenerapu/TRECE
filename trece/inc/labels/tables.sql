...
INSERT INTO `inconceivable_labels` (`id`, `id_status`, `name_en`, `url_name_en`, `name_gal`, `url_name_gal`, `name_es`, `url_name_es`, `date_reg`, `date_upd`, `ip_upd`, `ref`, `loops_ref`) VALUES
