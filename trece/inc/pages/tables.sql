...
INSERT INTO `inconceivable_pages` (`id`, `id_status`, `id_parent`, `ids_breadcrumb_trail`, `title`, `url_title`, `intro`, `post`, `date_reg`, `date_upd`, `ip_upd`, `ref`, `loops_ref`) VALUES
(1, 1,  0,  '1',  'Cookie policy',  'cookie-policy',  'Intro about Cookie policy.', '<p>All about the cookie policy.</p>',  NOW(),  NOW(),  '0.0.0.0',  LEFT(UUID(),8), 1),
(2, 1,  0,  '2',  'Privacy policy', 'privacy-policy', 'Intro about privacy policy.',  '<p>More about privacy policy.</p>',  NOW(),  NOW(),  '0.0.0.0',  LEFT(UUID(),8), 1);
